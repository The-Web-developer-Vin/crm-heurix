...
@Component({
    ...
    templateUrl: './payments-completed.component.html',
    styleUrls: ['./payments-completed.component.scss'],
})
export class PaymentsCompletedComponent implements OnInit {
    @Input() monthNumber;
    @Input() yearNumber;
    @Input() categoryName;
    @Input() monthName;
    ...
    @Input() currencyName;
    @Input('filterDataCompleted') filterDataCompleted: Subject<any>;
    ...
    ngOnInit(): void {
        ...
        this.filterDataCompleted.subscribe((e) => {
