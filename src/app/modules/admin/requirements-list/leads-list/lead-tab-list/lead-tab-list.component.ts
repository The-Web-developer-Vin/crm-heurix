...
@Component({
    selector: 'app-lead-tab-list',
    templateUrl: './lead-tab-list.component.html',
    styleUrls: ['./lead-tab-list.component.scss'],
})
export class LeadTabListComponent implements OnInit {
    @Input() tabName;
    @Input('filterDataLead') filterDataLead: Subject<any>;
