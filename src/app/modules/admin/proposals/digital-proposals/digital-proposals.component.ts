...
@Component({
    selector: 'app-digital-proposals',
    templateUrl: './digital-proposals.component.html',
    styleUrls: ['./digital-proposals.component.scss'],
})
export class DigitalProposalsComponent implements OnInit {
    @Input() tabName;
    @Input('filterDataDigital') filterDataDigital: Subject<any>;
