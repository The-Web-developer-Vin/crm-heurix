...
@Component({
    selector: 'app-onhold-list',
    templateUrl: './onhold-list.component.html',
    styleUrls: ['./onhold-list.component.scss'],
})
export class OnholdListComponent implements OnInit {
    @Input() tabName;
    @Input('filterDataInprogress') filterDataInprogress: Subject<any>;
    @Input() projectId;
