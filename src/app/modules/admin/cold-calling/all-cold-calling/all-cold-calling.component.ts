...
@Component({
    selector: 'app-all-cold-calling',
    templateUrl: './all-cold-calling.component.html',
    styleUrls: ['./all-cold-calling.component.scss'],
})
export class AllColdCallingComponent implements OnInit {
    @Input() tabName;
